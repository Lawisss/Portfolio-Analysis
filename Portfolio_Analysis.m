...
DJI = readtable('C:\Users\Nicolas\Documents\EFREI\Cours\M1\Cours\Cryptocurrency Design and Risk\TD\Lab\data\^DJI.csv');
FTSE = readtable('C:\Users\Nicolas\Documents\EFREI\Cours\M1\Cours\Cryptocurrency Design and Risk\TD\Lab\data\^FTSE.csv');
DAX = readtable('C:\Users\Nicolas\Documents\EFREI\Cours\M1\Cours\Cryptocurrency Design and Risk\TD\Lab\data\^GDAXI.csv');
HSX = readtable('C:\Users\Nicolas\Documents\EFREI\Cours\M1\Cours\Cryptocurrency Design and Risk\TD\Lab\data\^HSI.csv');
Nikkei = readtable('C:\Users\Nicolas\Documents\EFREI\Cours\M1\Cours\Cryptocurrency Design and Risk\TD\Lab\data\^N225.csv');
SP500 = readtable('C:\Users\Nicolas\Documents\EFREI\Cours\M1\Cours\Cryptocurrency Design and Risk\TD\Lab\data\^GSPC.csv');

%% Crypto import

BTC = readtable('C:\Users\Nicolas\Documents\EFREI\Cours\M1\Cours\Cryptocurrency Design and Risk\TD\Lab\data\hist_data_btceur_2020.csv');
...
% The value of the tests is 1, i.e. they reject the null hypothesis H0 (Gaussian distribution) and that the samples are not normally distributed.
...
ZoomInd   = (DatesTest >= datetime(2010,01,31)) & (DatesTest <= datetime(2010,03,31));
...
plot(D(IndN95),-N(IndN95),'o',D(IndHS95),-H(IndHS95),'o', D(IndEWMA95),-E(IndEWMA95),'o','MarkerSize',8,'LineWidth',1.5);
xlim([D(1)-1, D(end)+1]);
hold off;